    ...
    public class MySQLDatabase : IDisposable
    {
        ...
        public int Execute(string commandText, Dictionary<string, object> parameters, bool isProcedure = false)
        {
            ...
            try
            {
                ...
                var command = CreateCommand(commandText, parameters, isProcedure);
        ...
        /// <param name="parameters">Parameters to pass to the MySQL query</param>
        /// <returns></returns>
        private MySqlCommand CreateCommand(string commandText, Dictionary<string, object> parameters, bool isProcedure)
        {
