...
namespace AspNet.Identity.MySQL
{
        ...
        where TUser :IdentityUser
    {
        ...
        {
            string commandText = @"Insert into Users (UserName, FirstName, LastName, Id, PasswordHash, SecurityStamp,Email,EmailConfirmed,PhoneNumber,PhoneNumberConfirmed, AccessFailedCount,LockoutEnabled,LockoutEndDateUtc,TwoFactorEnabled, Sex, FathersName,MothersName,Birthdate, Address)
                values (@name, @fn, @ln, @id, @pwdHash, @SecStamp,@email,@emailconfirmed,@phonenumber,@phonenumberconfirmed,@accesscount,@lockoutenabled,@lockoutenddate,@twofactorenabled, @sex, @fathersName,@mothersName,@birthdate, @address)";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            ...
            parameters.Add("@fathersName", user.FathersName);
            parameters.Add("@mothersName", user.MothersName);
        ...
        {
            string commandText = @"Update Users set Address = @address, UserName = @userName, FirstName = @firstName, LastName = @lastName, Sex = @sex,FathersName=@fathersName,MothersName=@mothersName,Birthdate=@birthdate, PasswordHash = @pswHash, SecurityStamp = @secStamp, 
