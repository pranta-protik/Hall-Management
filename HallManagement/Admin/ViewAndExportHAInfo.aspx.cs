...
{
    public partial class ViewAndExportHAInfo : System.Web.UI.Page
    {
        ...
        protected void lnkStudentInfo_Click(object sender, EventArgs e)
        {
        ...
        protected void btnExportPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=HallAuthority.pdf");
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
                StringWriter sw = new StringWriter();
                HtmlTextWriter hw = new HtmlTextWriter(sw);
                gvAllHA.RenderControl(hw);
