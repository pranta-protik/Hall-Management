<%@ Page Title="View Hall Authority Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewHallAuthority.aspx.cs" Inherits="HallManagement.Admin.ViewHallAuthority" %>
        ...
        <div class="col-md-12">
            <div class="container">
                ...
                <div id="divStudentAccount" runat="server" class="col-md-2 col-md-offset-1 text-right">
                    <asp:LinkButton CssClass="btn btn-link" Text="<< Student Account" Style="font-size: medium" ID="lnkStudentAccoun" OnClick="lnkStudentAccoun_Click" runat="server" />
                </div>
            </div>
            <hr />
                    ...
                    <asp:GridView ID="gvAllHA" Width="100%" HeaderStyle-BackColor="#004256" RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle" BorderWidth="2" AlternatingRowStyle-BackColor="#d4d8dd" CssClass="table table-borderd table-responsive" CellPadding="5" AutoGenerateColumns="false" runat="server" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="White">
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:HiddenField ID="hfHAUId" runat="server" Value='<%# Eval("HAUId") %>' />
                                    <button type="button" class="btn btn-link" style="color: #0d5166" runat="server" id="lnkEdit" onserverclick="lnkEdit_ServerClick"><span class="glyphicon glyphicon-user" style="padding-right: 3px"></span>Edit</button>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
