<%@ Page Title="Apply for your seat" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Application.aspx.cs" Inherits="HallManagement.Applicaion" %>
            ...
            <div class="form-horizontal panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-md-6">
                        <asp:Button runat="server" ID="Apply" OnClick="Apply_Click" Text="Apply" CssClass="buttonp" Style="width: 100px" />
                    </div>
                </div>
                <br />
            </div>
