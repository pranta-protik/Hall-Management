<%@ Page Title="Add Notice" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNotice.aspx.cs" Inherits="HallManagement.Common.AddNotice" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="col-md-2 col-md-offset-1 text-right">
            <asp:LinkButton CssClass="btn btn-link" Text="<< Add News" Style="font-size: medium" ID="lnkAddNews" OnClick="lnkAddNews_Click" runat="server" />
