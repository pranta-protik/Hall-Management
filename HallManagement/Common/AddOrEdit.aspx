<%@ Page Title="Add Or Edit" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddOrEdit.aspx.cs" Inherits="HallManagement.Common.AddOrEdit" %>
                ...
                <div class="row">
                    <div class="panel col-md-6" style="background-color: #f4f4f4;">
                        ...
                        <div class="panel col-md-12 text-center" style="background-color: #0d5166; min-height: 150px; padding-top: 30px">
                            ...
                            <button type="button" id="btnAddNew" onserverclick="btnAddNew_ServerClick" runat="server" class="button">
                                <p class="glyphicon glyphicon-plus" style="color: white; font-size: xx-large; padding-right: 5px"></p>
                                <span>Add New </span>
                            </button>
                    ...
                    <div class="panel col-md-6" style="background-color: #f4f4f4;">
                        <div class="panel col-sm-12 text-center" style="background-color: #0d5166; min-height: 150px; padding-top: 30px">
                            <button type="button" id="btnEdit" onserverclick="btnEdit_ServerClick" runat="server" class="button">
                                <p class="glyphicon glyphicon-th-list" style="color: white; font-size: xx-large; padding-right: 10px"></p>
                                <span>Edit </span>
                            </button>
