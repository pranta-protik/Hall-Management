<%@ Page Title="Edit Notice" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditNotice.aspx.cs" Inherits="HallManagement.Common.EditNotice" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="col-md-2 col-md-offset-1 text-right">
            <asp:LinkButton CssClass="btn btn-link" Text="<< Edit News" Style="font-size: medium" ID="lnkEditNews" OnClick="lnkEditNews_Click" runat="server" />
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content" style="background-color: #f0f0f0">
                                ...
                                <div class="modal-footer">
                                    <asp:HiddenField ID="hfCurrentNotice" runat="server" />
                                    <button type="button" class="buttons" runat="server" id="btnRemoveNotice" onserverclick="btnRemoveNotice_ServerClick" style="width: 100px" >Yes</button>
