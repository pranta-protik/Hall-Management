<%@ Page Title="Register Students" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterApplication.aspx.cs" Inherits="HallManagement.Common.RegisterEditApplication" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="form-horizontal panel-body" style="background-color: #f8f8f8">
                <div class="panel panel-body" style="background-color: #f8f8f8">
                    <div class="col-md-12">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="divViewByRollNo" runat="server">
                                ...
                                <button type="button" id="btnSearchRNo" onserverclick="btnSearchRNo_ServerClick" runat="server" class="buttonf col-md-offset-1"><span class="glyphicon glyphicon-search"></span> Search</button>
                            ...
                            <div id="divViewByAppId" runat="server">
                                ...
                                <button type="button" id="btnSearchAId" onserverclick="btnSearchAId_ServerClick" runat="server" class="buttonf col-md-offset-1"><span class="glyphicon glyphicon-search"></span> Search</button>
                            ...
                            <div id="divViewByAddress" runat="server">
                                ...
                                <button type="button" id="btnSearchAddress" onserverclick="btnSearchAddress_ServerClick" runat="server" class="buttonf col-md-offset-1"><span class="glyphicon glyphicon-search"></span> Search</button>
                ...
                <div class="panel col-md-12" style="max-height: 500px; overflow-y: auto; background-color: #f8f8f8">
                    <asp:GridView ID="gvAllApplication" Width="100%" HeaderStyle-BackColor="#004256" RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle" BorderWidth="2" AlternatingRowStyle-BackColor="#d4d8dd" CssClass="table table-borderd table-responsive" CellPadding="5" AutoGenerateColumns="false" runat="server" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="White">
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:Label Text="Register Student" runat="server" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:HiddenField ID="hfApplicationNo" runat="server" Value='<%# Eval("ApplicationNo") %>' />
                                    <button type="button" class="btn btn-link" style="color: #0d5166" runat="server" id="lnkRegister" onserverclick="lnkRegister_Click"><span class="glyphicon glyphicon-edit" style="padding-right:3px"></span>Register</button>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
