...
{
    public partial class RegisterEditApplication : System.Web.UI.Page
    {
        ...
        {
            var appDetail = new MySQLDatabase().Query("getAllUnApplicationDetail", new Dictionary<string, object>(), true);
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByDesc", new Dictionary<string, object>(), true);
            var applicationDetail = appDetail.Select(x => new
            {
                ApplicationNo = x["id"],
                FName = x["FirstName"],
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByRollNo", new Dictionary<string, object>()
            {
        ...
        {
            var bGroup = new MySQLDatabase().Query("getUnApplicationByBGroup", new Dictionary<string, object>()
            {
        ...
        {
            var phone = new MySQLDatabase().Query("getUnApplicationByPhoneNo", new Dictionary<string, object>()
            {
        ...
        {
            var name = new MySQLDatabase().Query("getUnApplicationByName", new Dictionary<string, object>()
            {
                {"@name",txtName.Text+'%' }
            }, true);
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByAddress", new Dictionary<string, object>()
            {
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByAId", new Dictionary<string, object>()
            {
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByRange50", new Dictionary<string, object>(), true);
            var applicationDetail = appDetail.Select(x => new
            {
                ApplicationNo = x["id"],
                FName = x["FirstName"],
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByRange100", new Dictionary<string, object>(), true);
            var applicationDetail = appDetail.Select(x => new
            {
                ApplicationNo = x["id"],
                FName = x["FirstName"],
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByRange150", new Dictionary<string, object>(), true);
            var applicationDetail = appDetail.Select(x => new
            {
                ApplicationNo = x["id"],
                FName = x["FirstName"],
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByRange200", new Dictionary<string, object>(), true);
            var applicationDetail = appDetail.Select(x => new
            {
                ApplicationNo = x["id"],
                FName = x["FirstName"],
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByBatch", new Dictionary<string, object>()
            {
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByHallDiscipline", new Dictionary<string, object>()
            {
        ...
        {
            var appDetail = new MySQLDatabase().Query("getUnApplicationByHall", new Dictionary<string, object>()
            {
        ...
        {
            HtmlButton lnkRegister = (HtmlButton)sender;
            GridViewRow row = (GridViewRow)lnkRegister.NamingContainer;
            HiddenField hfApplicationNo = (HiddenField)row.FindControl("hfApplicationNo");
            Response.Redirect("~/Common/RegisterStudent.aspx?AId=" + Server.UrlEncode(hfApplicationNo.Value));
            //Response.Write(hfApplicationNo.Value);
        }
