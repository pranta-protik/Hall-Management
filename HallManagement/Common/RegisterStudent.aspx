<%@ Page Title="Create Student Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterStudent.aspx.cs" Inherits="HallManagement.Common.RegisterStudent" %>
