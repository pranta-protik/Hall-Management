<%@ Page Title="View Student Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewStudent.aspx.cs" Inherits="HallManagement.Common.ViewStudent" %>
        ...
        <div class="col-md-12">
            <div class="container">
                ...
                <div id="divHAAccount" runat="server" class="col-md-2 col-md-offset-1 text-right">
                    <asp:LinkButton CssClass="btn btn-link" Text="Hall Authority Account >>" Style="font-size: medium" ID="lnkHallAuthorityAccount" OnClick="lnkHallAuthorityAccount_Click" runat="server" />
                </div>
            </div>
            <hr />
                ...
                <div class="panel col-md-12" style="max-height: 500px; overflow-y: auto; background-color: #f4f4f4">
                    <asp:GridView ID="gvAllStudent" Width="100%" HeaderStyle-BackColor="#004256" RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle" BorderWidth="2" AlternatingRowStyle-BackColor="#d4d8dd" CssClass="table table-borderd table-responsive" CellPadding="5" AutoGenerateColumns="false" runat="server" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="White">
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:Label Text="Edit Account" runat="server" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:HiddenField ID="hfStudUId" runat="server" Value='<%# Eval("StudUId") %>' />
                                    <button type="button" class="btn btn-link" style="color:#0d5166" runat="server" id="lnkEdit" onserverclick="lnkEdit_Click"><span class="glyphicon glyphicon-user" style="padding-right:3px"></span>Edit</button>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
