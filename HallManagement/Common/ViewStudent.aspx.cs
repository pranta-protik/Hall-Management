...
namespace HallManagement.Common
{
    public partial class ViewStudent : System.Web.UI.Page
    {
        ...
        protected void lnkHallAuthorityAccount_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin/ViewHallAuthority.aspx");
        }
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            ...
            HiddenField hfStudUId = (HiddenField)row.FindControl("hfStudUId");
            Response.Redirect("~/Common/EditStudent.aspx?SUId=" + hfStudUId.Value);
        }
    }
}