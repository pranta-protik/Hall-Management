<%@ Page Title="Your personal info" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="HallManagement.HallAuthority.Dashboard" %>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="form-horizontal panel-body" style="background-color: #f4f4f4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <label id="lblPosition" runat="server"></label>
                    </div>
                </div>
                <div class="form-group">
